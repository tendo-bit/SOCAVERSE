...
// File: contracts/interfaces/IBUSDLottery.sol

pragma solidity ^0.8.4;

interface IBUSDLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the BUSD lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == busdLottery, "Only BUSDLottery");
    ...
    /**
     * @notice Set the address for the busdLottery
     * @param _busdLottery: address of the busd lottery
     */
    function setLotteryAddress(address _busdLottery) external onlyOwner {
        busdLottery = _busdLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBUSDLottery(busdLottery).viewCurrentLotteryId();
    }
}