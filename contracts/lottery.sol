...
// File: contracts/BUSDLottery.sol
 ...
 */
contract BUSDLottery is ReentrancyGuard, IBUSDLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId].amountCollectedInBusd - amountToShareToWinners);
