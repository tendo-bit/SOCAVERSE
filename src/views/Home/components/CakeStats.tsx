  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">{t('SOCA Price')}</Text>
          <Text fontSize="14px">${NNPriceBusd.times(1000000000).toNumber() / 100000000}</Text>
        </Row>
        <Row>
        ...
        {/* <Row>
          <Text fontSize="14px">{t('Rewards SOCA/block')}</Text>
