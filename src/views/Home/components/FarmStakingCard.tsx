...
const FarmedStakingCard = () => {
    ...
    const tokenAdded = await window.ethereum.request({
      ...
      params: {
        ...
        options: {
          ...
          image: `https://socaverse.finance/images/logo.png`,
        },
      },
    })
  ...
  const numFarmsToCollect = farmsWithStakedBalance.filter((value) => value.pid !== 2).length
  ...
  const harvestAllFarms = useCallback(async () => {
    ...
    for (const farmWithBalance of farmsWithStakedBalance) {
      try {
        ...
        toastSuccess(
          `${t('Harvested')}!`,
          t('Your %symbol% earnings have been sent to your wallet!', { symbol: 'SOCA' }),
        )
      } catch (error) {
      ...
      <CardBody>
        ...
        <Actions>
          ...
          <Flex >
            ...
            >
              {pendingTx ? t('Collecting SOCA') : t(`Harvest all (${numFarmsToCollect})`)}
            </StyledButton>
            <a href='/swap'>
            <StyledButton>
              Buy SOCA Token
