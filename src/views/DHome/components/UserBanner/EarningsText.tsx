...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SOCA pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SOCA pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SOCA pool', data)
  }
